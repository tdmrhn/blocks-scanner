document.addEventListener("DOMContentLoaded", () => {
    class BlocksScanner {
        constructor() {
            this.blocksScannerWrapper = document.querySelector(".blocks_scanner");
            this.tabWrapper = this.blocksScannerWrapper.querySelectorAll(".nav-tab-wrapper a");
            this.tabContent = this.blocksScannerWrapper.querySelectorAll(".tab-content");
            this.filterInputs = this.blocksScannerWrapper.querySelectorAll('.tab-content .dhn-filter, .tab-content .block-checkbox');
            this.initialize();
        }
